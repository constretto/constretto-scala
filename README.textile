...
Constretto is cross compiled for Scala versions 2.10, 2.11 (from v.1.1) and 2.12 (from v.1.2) and deployed to the maven central repository.
...
<pre>
	val constretto = "org.constretto" %% "constretto-scala" % "1.2"
</pre>
