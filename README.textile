...
Constretto is cross compiled for scala versions 2.9.0 and 2.9.1 and deployed to the maven central repository.
...
<pre>
	val constretto = "org.constretto" %% "constretto-scala" % "1.0-beta-2"
</pre>
